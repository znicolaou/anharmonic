...
parser.add_argument("--disorder", type=float, default=0.0, dest='epsilon', help='Noise intensity')
...
parser.add_argument("--rtol", type=float, default=1e-2, dest='rtol', help='Relative tolerance')
